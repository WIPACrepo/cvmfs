...
class Vecgeom(CMakePackage, CudaPackage):
    ...
    version(
        "1.2.11",
        url="https://gitlab.cern.ch/VecGeom/VecGeom/-/archive/v1.2.11/VecGeom-v1.2.11.tar.gz",
        sha256="30a3e5eb470cb346324d7df7aeb441224386015331f45721f770760dd1cf8ba6",
    )
    version(
        "1.2.9",
