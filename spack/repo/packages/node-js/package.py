...
class NodeJs(Package):
    ...
    url      = "https://nodejs.org/download/release/v10.10.0/node-v10.10.0.tar.gz"

    version('10.10.0', sha256='00b7a8426e076e9bf9d12ba2d571312e833fe962c70afafd10ad3682fdeeaa5e')
    version('8.12.0', sha256='ca131b84dfcf2b6f653a6521d31f7a108ad7d83f4d7e781945b2eca8172064aa')
    ...
    def install(self, spec, prefix):
        if spec['python'].version >= Version('3.0') and 'PYTHONHOME' in env:
            del env['PYTHONHOME']
        options = []
