...
class PyPytables(PythonPackage):
    ...
    depends_on('hdf5@1.8.0:1.8.999', when='@:3.2.9')
    depends_on('hdf5@1.9.0:', when='@3.3.0:')
    depends_on('c-blosc', when='@3.3.0:')
    depends_on('lzo', when='@3.3.0:')
    depends_on('bzip2', when='@3.3.0:')
