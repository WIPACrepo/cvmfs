...
class PySetuptoolsScm(PythonPackage):
    ...
    depends_on("py-tomli@1:", when="@7:7.1", type=("build", "run"))
    # when python@3.11: use tomllib from stdlib instead
    depends_on("py-tomli@1:", when="@7.1: ^python@3.11:", type=("build", "run"))
